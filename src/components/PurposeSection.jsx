    ...
    <section className='w-full bg-gray-50 py-16 px-4 sm:px-8' id='about'>
        <div className='max-w-6xl mx-auto'>
            <div className='grid md:grid-cols-3 grid-cols-1 gap-8'>
                ...
                {/* Bullet Point */}
                <div className='col-span-2 grid grid-cols-1 md:grid-cols-2 justify-center gap-8'>
                    {
                        features.map((feature, index) => (
                            <div key={index} className='flex items-start gap-4'>
                                <span className='w-12 h-12 flex items-center justify-start rounded-lg'>{feature.icon}</span>
                                <div>
