        ...
        <section id="home" className='container mx-auto pt-34 pb-6 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center'>
            ...
            <div className='w-full md:w-1/2 space-y-8'>
                ...
                <motion.div
                    ...
                    />
                    <button className='bg-blue-600 text-white py-3 px-4 md:py-4 md:px-6 rounded-xl hover:bg-blue-700 cursor-pointer transition-all hover:shadow-lg hover:shadow-blue-300 text-2xl md:text-4xl items-center justify-center'> → </button>
                </motion.div>
