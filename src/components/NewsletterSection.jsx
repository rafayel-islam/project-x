        ...
        <section className='container mx-auto px-4 sm:px-6 lg:px-8 py-16' id='newsletter'>
            <div className='bg-blue-600 rounded-2xl overflow-hidden'>
                <div className='relative md:px-16 py-16 px-6 md:py-24'>
                    ...
                    {/* gradiant bg */}
                    <div className='absolute top-0 right-0 w-1/2 h-full bg-blue-700 clip-path-diagonal hidden md:block'>
                    </div>
                    ...
                    <div className='relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12'>
                        ...
                        <div className='flex flex-col sm:flex-row gap-4 sm:gap-0'>
                            ...
                            <button className='w-full sm:w-auto cursor-pointer bg-green-500 hover:bg-green-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-xl sm:rounded-l-none sm:rounded-r-lg flex items-center gap-2'>
                                <span>Discover</span>
